...
using JP.Base.MVP.Implementation.Support.Factories;
using JP.Base.MVP.Implementation.Winforms.Contracts.Base;
using JP.Base.MVP.Implementation.Winforms.Implementation.Messages;
using JP.Base.MVP.Implementation.Winforms.Pagination;
using JP.Base.MVP.Implementation.Winforms.Searching;

namespace JP.Base.MVP.Implementation.Winforms.Implementation.Views.Controls.Base
{
    /// <summary>
